  ...
  <div class="home">
    ...
    <div class="content">
      <div class="div-current-step">
        <div class="full-bg" v-show="currentStep=='home'"></div>
        <div class="showsites" v-show="currentStep=='showsites'">
          <div class="site-show">
            <div class="site" @click="chooseSite(l)" v-for="l in sites" :key="l.id">
              ...
              <br />
              <div class="site-metro-name">{{l.metroName}}</div>
            </div>
          </div>
        </div>
        ...
        <div class="showlines" v-show="currentStep=='showlines'">
          <div class="lines-show">
            <div class="line" @click="showOrderticket" v-for="l in recommandLines" :key="l.index">
        ...
        <div
          class="orderticket"
          v-show="currentStep=='orderticket'||currentStep=='pay'||currentStep=='payresult'"
        >
          <div class="left">
            <img src="./../../assets/img/subway/line1.jpg" />
          </div>
          <div class="right">
    ...
    <div class="ws-message">{{mic_state}} -- {{wsmessage}}</div>
...
export default {
  ...
  methods: {
    ...
    showOrderticket() {
      ...
      self.sendMessage("skill.metro.buy", "");
    ...
    initWebsocket() {
      ...
      websocket.onopen = function() {
        ...
        websocket.send(
          '{"event": "subscribe", "data": [{"topic":"command://DUI.Metro.BuyTickets"}]}'
        );
      };
      //接收到消息的回调方法
...
.div-current-step {
  ...
  .full-bg {
    width: 100%;
    height: 100%;
    background-image: url("./../../assets/img/subway/bg-full.jpg");
